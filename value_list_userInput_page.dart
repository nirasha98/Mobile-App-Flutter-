...
class ForthPage extends StatefulWidget {
  final ValueList_UserInput? userInput;
  final int initialValue;
  final int index;
  final String TiTle; // Define the TiTle field
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  List<dynamic> Updated_values = [
                                    title,
                                    intValue
                                  ];

                                  if (title.isNotEmpty && value.isNotEmpty) {
                                    final userInput = ValueList_UserInput(
                                      title: title,
                                      value: value,
                                    ...
                                    //Navigator.pop(context, Updated_values);

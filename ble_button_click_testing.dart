          ...
          if (desiredService != null) {
            ...
            if (desiredCharacteristic != null) {
              ...
              desiredCharacteristic.value.listen((data) {
                setState(() {
                  print('start listerning');
                  value = data.toList();
                  // Convert the data to a List<int> and update the value list
                  print(data);
                });
              });
              ...
              //   //   setState(() {
              //   //     value = data
              //   //         .toList(); // Convert the data to a List<int> and update the value list
              //   //   });
              //   // });
...
//commented @ 12.05
  ...
  //             );
  //             if (desiredDescriptor != null) {
  //               desiredDescriptor.write([0x01, 0x00]).then((_) {
  //                 desiredCharacteristic.value.listen((data) {
  //                   setState(() {
  //                     value = data;
  //                   });
...
//commented at 05/25 @ 11.33
  // void _setupCharacteristicListener() {
  //   final desiredServiceUuid = Guid('000000FF-0000-1000-8000-00805F9B34FB');
  //   final desiredCharacteristicUuid =
  //       Guid('0000FF01-0000-1000-8000-00805F9B34FB');
  //   final desiredDescriptorUuid = Guid(
  //       '00002902-0000-1000-8000-00805F9B34FB'); // Descriptor UUID for enabling notifications or indications
  ...
  //             if (desiredDescriptor != null) {
  //               print('\n\n');
  //               print('Found desired descriptor: ${desiredDescriptor.uuid}');
  //               print('\n\n');

  //               // Enable notifications or indications by writing the corresponding descriptor value
  //               await desiredDescriptor.write([
  //                 0x01,
  //                 0x00
  //               ]); // Replace [0x01, 0x00] with [0x02, 0x00] for indications

  //               // You can now start reading or listening to notifications/indications from the characteristic
  //               if (desiredCharacteristic != null) {
  //                 print('\n\n');
